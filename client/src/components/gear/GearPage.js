        ...
        <Stack sx={{p:1}} spacing={2}>
          ...
          {gear && (
            <>
              ...
              {gear.contactEmail && <Typography variant="body1" gutterBottom>Email: {gear?.contactEmail}</Typography>}
              {gear.contactPhone && <Typography variant="body1" gutterBottom>Phone: {gear?.contactPhone}</Typography>}
            </>
          )}
        </Stack>
        </Stack>
